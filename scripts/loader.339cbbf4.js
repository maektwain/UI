(function () {
    require.config({
        paths: {
            ...
            'wiz.validation':'../bower_components/wiz-validation/wizValidation/wizValidation.min',
          //  'jcs-autoValidate': '../bower_components/angular-auto-validate/dist/jcs-auto-validate.min',
        },
        shim: {
            ...
            'wiz.validation':{deps:['angular']},
          //  'jcs-autoValidate':{deps:['angular']},
    ...
    require(['mifosXComponents.67982dcc', 'mifosXStyles.8e9b8092'], function (componentsInit) {
